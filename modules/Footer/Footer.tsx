  ...
  return (
    <div className="bg-[#009398] w-full h-[300px] flex justify-evenly gap-[125px]">
      <div className="flex flex-col items-center gap-[20px] w-[331px] mt-[15px]">
        ...
        />
        <button className="w-[220px] h-[37px] bg-[#FFE600] hover:bg-gray-500 transition-colors px-[13px] rounded-[10px] shadow-2xl font-bold text-[20px]">
          Buyurtma berish
        </button>
      </div>
      <div className="mt-[15px] flex flex-col gap-[10px]">
        <div className="flex items-center gap-[13px]">
          <ClockIcon />
          <span className="text-[20px] text-white font-bold">Ish vaqti</span>
        </div>
